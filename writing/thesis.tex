...
\begin{table}
    \centering
    \captionof{table}{Treatment Dose Distribution Across Countries}
    % \resizebox{14cm}{!}{
    \footnotesize{
...
\begin{table}
    \centering
    \captionof{table}{Treatment Distribution Across Stock Exchanges}\label{tab:exchngs}
...
\begin{table}[ht]
    \captionof{table}{Estimation Periods for Variable}\label{tab:data_freq}
