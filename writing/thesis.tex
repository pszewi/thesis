...
\begin{figure}[t]
    ...
    \includegraphics[width=\textwidth]{fff_trend.png}
    \captionsetup{font=footnotesize}
    \caption*{Proportion of searches relative to the most searched. Red dots show major strikes organized my FFF.\@ These strikes happened on the following dates (from left to right): 15--03--2019, 20--09--2019, 27--09--2019, 29--11--2019. Source: Google Trends}
\end{figure}
...
\begin{figure}[t]
    ...
    \centering
    \includegraphics[width=\textwidth]{stock_d_trend.png}
    \captionsetup{font=footnotesize}
...
\begin{figure}[t]
    ...
    \centering
    \includegraphics[width=\textwidth]{sales_trend.png}
    \captionsetup{font=footnotesize}
